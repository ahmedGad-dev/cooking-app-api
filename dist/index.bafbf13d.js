...
//https://forkify-api.herokuapp.com/api/v2/recipes?search=pizza&key=e4db81ef-099e-4a7c-807b-91cec76aeb35
...
const fetchReciecpe = async ()=>{
    ...
    <div class="recipe__directions">
      ...
      <p class="recipe__directions-text">
        ...
        <span class="recipe__publisher">${publihser}</span>. Please check out
...
[
    "hashchange",
    "load"
].forEach((event)=>window.addEventListener(event, fetchReciecpe));
...
},{"core-js/modules/web.immediate.js":"49tUX","./model":"dEDha","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","url:./img/icons.svg":"3BUq2"}],"49tUX":[function(require,module,exports) {
...
const loadRecipe = async (id)=>{
    try {
        ...
        const { id: recipeID , title , publihser , sourceUrl , image_url , servings , ingredients , cooking_time  } = state.recipe;
    } catch (error) {
        console.log(error);
    }
};
...
},{}],"3BUq2":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bWBrl") + "icons.dfd7a6db.svg" + "?" + Date.now();
...
},{}]},["6KagL","gCE4p"], "gCE4p", "parcelRequire7e89")
